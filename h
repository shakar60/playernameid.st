...
local Tab8Section = Tab8:NewSection("User Info")
...
Tab8Section:NewLabel("game.Players.LocalPlayer.AccountAge")

Tab18Section:NewLabel("discord is shakar60")

Tab18Section:NewLabel("Credits To All The Poeple That Make The Scripts")

Tab18Section:NewLabel("Script Hub Is Made By shaka60")
